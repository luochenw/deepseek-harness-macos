...
`scripts/patch-agent-platform-runtime.mjs` is version-gated to DSH rc.6/rc.7
and fails the app build when expected source anchors drift. It adds:
...
- exact authorized `disposeContinuable`;
