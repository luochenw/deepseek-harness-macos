...
- `main.swift` 的历史债分批拆分已完成（504 行，App 入口 + `HarnessController` 类声明 + `@Published` 状态 + 核心生命周期），进度与决策见 [Agent Note](.agents/notes/proposed/architecture/2026-08-18-quality-remediation-plan.md)。
